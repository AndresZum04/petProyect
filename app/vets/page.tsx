            ...
            <div className="flex gap-3">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-4 py-2.5 rounded-xl border border-border bg-white text-sm focus:outline-none focus:ring-2 focus:ring-primary-400 focus:border-transparent"
                />
              </div>
              <Link
                href="/vets/register"
                className="flex items-center gap-2 bg-gradient-amber text-white text-sm font-semibold px-4 py-2.5 rounded-xl shadow-warm whitespace-nowrap"
              >
                  ...
                  <div key={vet.id} className="bg-white rounded-2xl shadow-card p-5 hover:shadow-warm-md transition-all">
                    <div className="flex items-start justify-between gap-3 mb-3">
                      <div className="flex-1 min-w-0">
                        <h2 className="font-heading font-bold text-foreground text-lg leading-tight mb-1">
                          {vet.name}
                        </h2>
                    ...
                    <div className="flex items-center gap-4 mb-4">
                      <div className="flex items-center gap-1.5 text-sm text-muted-foreground">
                        ...
                        {t.vets.rescuersCount(vetRescuers.length)}
                      </div>
                      <div className="flex items-center gap-1.5 text-sm text-muted-foreground">
                        <PawPrint className="w-4 h-4 text-primary-400" />
                        {t.vets.petsCount(vetPetsCount)}
                      </div>
                    </div>

                    <Link
                      href={`/vets/${vet.id}`}
                      className="inline-flex items-center gap-2 bg-gradient-amber text-white text-sm font-semibold px-4 py-2.5 rounded-xl shadow-warm hover:shadow-warm-md transition-all"
                    >
                      {t.vets.viewProfile}
                    </Link>
                  </div>
