...
const DEMO_VETS: Vet[] = [
  {
    id: 'vet-1',
    name: 'Centro Veterinario Los Yoses',
    city: 'San José',
    phone: '+506 2224-5678',
    email: 'info@veterinarialосyoses.cr',
  ...
  {
    id: 'vet-2',
    name: 'Refugio Animalito de Costa Rica',
    city: 'Heredia',
    phone: '+506 2261-3490',
    email: 'contacto@animalitocr.org',
  ...
  {
    id: 'vet-3',
    name: 'Patas y Colas Cartago',
    city: 'Cartago',
    phone: '+506 2552-1234',
    email: 'patasycolas@gmail.com',
